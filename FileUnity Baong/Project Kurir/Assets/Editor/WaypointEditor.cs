...
public class WaypointEditor
{
    ...
    public static void OnDrawSceneGizmo(WaypointAja waypoint, GizmoType gizmoType)
    {
        ...
        if(waypoint.perempatan != null){
            foreach(WaypointAja branch in waypoint.perempatan){
